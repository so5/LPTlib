...
public:
  ...
  {
    return (BlockBoundaryX[GetBlockIDX(BlockID)] - SubDomainBoundaryX[GetSubDomainIDX(SubDomainID)]) + (BlockBoundaryY[GetBlockIDY(BlockID)] - SubDomainBoundaryY[GetSubDomainIDY(SubDomainID)]) * (GetSubDomainSizeX(GetSubDomainIDX(SubDomainID)) + GetGuideCellSize() * 2) + (BlockBoundaryZ[GetBlockIDZ(BlockID)] - SubDomainBoundaryZ[GetSubDomainIDZ(SubDomainID)]) * (GetSubDomainSizeX(GetSubDomainIDX(SubDomainID)) + GetGuideCellSize() * 2) * (GetSubDomainSizeY(GetSubDomainIDY(SubDomainID)) + GetGuideCellSize() * 2);
  }
