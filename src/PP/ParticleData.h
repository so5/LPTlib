...
public:
  ...
  {
    return (this->ParticleID == obj.ParticleID && this->StartPointID1 == obj.StartPointID1 && this->StartPointID2 == obj.StartPointID2 && this->x == obj.x && this->y == obj.y && this->z == obj.z && this->StartTime == obj.StartTime) ? true : false;
  }
};
...
struct CompareID
{
  bool operator()(const ParticleData* left, const ParticleData* right) const
  {
    ...
    {
      return left->StartPointID1 < right->StartPointID2;
    }
    if (left->StartPointID2 != right->StartPointID2)
    {
      return left->StartPointID2 < right->StartPointID2;
    }
